...
public interface PropietarioRepository extends JpaRepository<Propietario, Integer> {
	...
	List<Propietario> findByLoteAndNumeroAndNombreAndApellidoOrderByLoteAsc(String lote, int numero, String nombre, String apellido);
	
	//Sentencia para saber quienes son propietarios y quien son inquilinos dentro del barrio.
