...
public interface VisitaRepository extends JpaRepository<Visita, Integer> {
	...
	List<Visita> findByNombreAndApellidoAndLoteAndNumeroOrderByLoteAsc(String nombre, String apellido, String lote,
			int numero);

	List<Visita> findByRegistrosIsNullOrRegistrosIngresoIsNotNullAndRegistrosEgresoIsNotNull();
